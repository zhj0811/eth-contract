...
contract awaken is Ownable {
    ...
    function getMainAddr() public view onlyOwner returns (address) {
        return mainAddr;
    }

    function withdrawDeveloperReward() public onlyOwner {
    ...
    function withdrawMainReward() public onlyOwner {
